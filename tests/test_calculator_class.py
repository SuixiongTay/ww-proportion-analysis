...
class TestWWProportionCalculator:
    ...
    def sample_calculator(self, sample_dataframe):
        ...
        calc = ww_proportion_calculator(
            sample_dataframe, representative_ions, "TestIndustry"
        )
        return calc
...
class TestCalculatorDataStorage:
    ...
    def sample_calculator(self, sample_dataframe):
        representative_ions = ["Na[+1]", "Cl[-1]"]
        return ww_proportion_calculator(
            sample_dataframe, representative_ions, "TestIndustry"
        )
    ...
    def test_final_element_proportions_initialized(self, sample_calculator):
        ...
        assert isinstance(
            sample_calculator.final_element_proportions_from_initial_median, dict
        )
